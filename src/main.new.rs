...
use syntect::highlighting::{Style, ThemeSet, ThemeSettings};
...
fn main() -> Result<(), Box<dyn Error>> {
    ...
    let mut high = HighlightLines::new(syntax, &ts.themes["base16-ocean.dark"]);

    let buf = TextBuffer::new(&high, buffer::BufferOrigin::Empty, None, None);
    ...
    let font_data = include_bytes!("../TerminusTTF.ttf");
